...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-primary/80 backdrop-blur-xl border-b border-white/5 py-3 shadow-lg' : 'bg-transparent py-5'}`}>
